...
public class SimpleObjects {
    ...
    public SimpleObject create(
            ...
            @ParameterLayout(named = "Apellido paterno") String apaterno,
            @ParameterLayout(named = "Apellido materno") String amaterno,
            @ParameterLayout(named = "Fecha nacimiento") LocalDate fechan,
            @ParameterLayout(named = "Sexo") Sexos sexo) {
        SimpleObject obj = new SimpleObject(name);
        obj.setApaterno(apaterno);
        obj.setAmaterno(amaterno);
        obj.setSexo(sexo);
        obj.setFechan(fechan);
